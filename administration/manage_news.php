...
<form method="get">
    ...
    <div class="container" id="MainContainer">
    	<div class="row">
        	<div class="col-sm-12">
            		<h1 style="color:#336699;">Manage News</h1>
                    ...
                    <br /> 
                      ...
                      <div class="row">
                    	<div class="col-sm-6"><a href='add_news.php' class='btn btn-success pull-left'><i class='fa fa-plus'></i>&nbsp; Add News </a></div>
...
(select Concat(lastname,',',firstname) as Fullname from tbl_user where userid=upload_by) as  'Upload By' FROM `tbl_news` where arc=0";
   ...
   echo "<tbody>";
	...
	
	{
 		 	...
 		 	echo "<tr>";  
				...
				echo "<td align='center'>"; 
        	 		 echo "<a href='edit_news.php?newsid=$row[newsid]' class='btn btn-warning'><i class='fa fa-pencil'></i></a>";  
				echo "</td >"; 
				
				echo "<td align='center'>"; 
        	 		 echo "<a href='archive_news.php?newsid=$row[newsid]' class='btn btn-danger' ><i class='fa fa-trash-o'></i></a>";  
