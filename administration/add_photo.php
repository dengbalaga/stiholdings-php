...
<form action="uploader_add_photo.php"  enctype="multipart/form-data" method="POST">
	

    <div class="container" id="MainContainer">
    	<div class="row">
        	<div class="col-sm-12">
            		<h1 style="color:#336699;">Add Photo</h1>
                    ...
                    <br /> 
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                        	<div class="col-sm-2"><h4> Photo</h4></div>
                            <div class="col-sm-10"> 
                                ...
                                <div id="hideimg" style="display:none;"> 
                                     <img id="blah" src="#" alt="" class="img-responsive img-rounded"   />
                                     <br />
                                    <br />
                                </div> 
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                            	<a href="manage_photos.php" class="btn btn-danger form-control">Cancel</a> 
                            </div>
